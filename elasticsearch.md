...
É uma ferramenta open-source altamente escalável que permite análise e pesquisa full-text.  
Armazena, pesquisa e análisa grandes volumes de dados rapidamente quase em tempo real.
...
- Cluster: coleção de um ou mais nodes (servidores) que mantém todos os dados. É identificado por um nó, nomeado por padrão "elasticsearch". Os nós se juntam ao cluster através do nome do cluster. Cuidado em usar mesmos nomes de cluster em ambientes diferentes.
